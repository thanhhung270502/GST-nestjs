    ...
    if month == 2:
        for day in range(1, 29):
            for hour in range(24):
                ...
                s = "INSERT INTO climate (id, type, value, time) VALUES ('" + str(id) + "', 'temp', " + str(value) + ", '" + str(time) + "');"
                print(s)
                i += 1
...
for i in range(40):
    ...
    s = "INSERT INTO climate (id, type, value, time) VALUES (i, 'temp', " + str(value) + ", 2023-04-26 " + str(time)
    # print(s)
